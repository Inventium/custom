...
function page_noheader_nofooter_nosidebar() {
    get_header(apply_filters('thesis_get_header', $name));
    echo '<div id="container">' . "\n";
    echo '<div id="page">' . "\n";
    echo '	<div id="content_box" class="no_sidebars">' . "\n";
...
function page_header_nofooter_nosidebar() {
    get_header(apply_filters('thesis_get_header', $name));
    echo '<div id="container">' . "\n";
    echo '<div id="page">' . "\n";
    thesis_header_area();
...
function page_header_footer_nosidebar() {
    get_header(apply_filters('thesis_get_header', $name));
    echo '<div id="container">' . "\n";
    echo '<div id="page">' . "\n";
    thesis_header_area();
...
function page_header_footer_sidebar() {
    get_header(apply_filters('thesis_get_header', $name));
    echo '<div id="container">'."\n";
    echo '<div id="page">'."\n";
    thesis_header_area();
